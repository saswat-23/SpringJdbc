...
public class StudentService {
	...
	//Get the list of Student objects grouped by address
	public Map<String, List<Student>> getStudentInfoGroupedByAddress() {
		return repo.getStudentsGroupedByAddress();
	}
